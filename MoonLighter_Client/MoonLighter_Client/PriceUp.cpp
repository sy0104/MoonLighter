...
HRESULT CPriceUp::Ready_Object()
{
	...
	if (FAILED(CTextureMgr::Get_Instance()->Insert_Texture(CTextureMgr::TEX_SINGLE, L"../Texture/SingleTex/Price_Up.png", L"PriceUp")))
	{
		ERR_MSG(L"PriceUp Insert Failed");
	}
...
void CPriceUp::LateUpdate_Object()
{
}

void CPriceUp::Render_Object()
{
	D3DXMATRIX	matScale, matTrans, matWorld;

	const TEXINFO* pTexInfo = CTextureMgr::Get_Instance()->Get_TexInfo(L"PriceUp");
